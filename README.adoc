...
[source]
----
implementation 'se.signatureservice.support:signservice-support-lib:2405.1'
----
== Usage Guide
...
A custom message security provider can be created by implementing `org.signatureservice.messages.MessageSecurityProvider`.
