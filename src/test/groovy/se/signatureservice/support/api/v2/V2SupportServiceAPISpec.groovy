...
class V2SupportServiceAPISpec extends Specification {
    ...
    void setupSpec(){
        ...
        supportServiceAPI = new V2SupportServiceAPI.Builder()
            ...
            .trustedCertificateSource(new TrustedListsCertificateSourceBuilder("https://ec.europa.eu/tools/lotl/eu-lotl.xml", "https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=uriserv:OJ.C_.2019.276.01.0001.01.ENG").getTrustedCertificateSource())
