...
/**
 * Pre-processing of signature attributes for documents signed using CAdES
 * algorithm.
 *
 * @author Tobias Agerberg
 */
public class CAdESSignatureAttributePreProcessor extends BaseSignatureAttributePreProcessor {
